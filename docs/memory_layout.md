...
exist in GLSL (like the int8 and int16 types). We allow them in Amber to give
flexibility in the data provided, but attempt to follow the layout rules with
all types for consistency.
...
## Matrices (All matrices are column matrices)
### STD140
| Name           | Bytes                                                                                                                      |
|----------------|----------------------------------------------------------------------------------------------------------------------------|
...
| Name           | Bytes                                                                                                                      |
|----------------|----------------------------------------------------------------------------------------------------------------------------|
| mat2x2\<fp16>  | <kbd>[bbbb][bbbb]                                                                                                   </kbd> |
| mat2x2\<float> | <kbd>[bbbb][bbbb][bbbb][bbbb]                                                                                       </kbd> |
| mat2x3\<float> | <kbd>[bbbb][bbbb][bbbb][----]<br/>[bbbb][bbbb][bbbb][----]                                                          </kbd> |
| mat2x4\<float> | <kbd>[bbbb][bbbb][bbbb][bbbb]<br/>[bbbb][bbbb][bbbb][bbbb]                                                          </kbd> |
| mat2x2\<int8>  | <kbd>[bbbb]                                                                                                         </kbd> |
| mat3x2\<float> | <kbd>[bbbb][bbbb]<br/>[bbbb][bbbb]<br/>[bbbb][bbbb]                                                                 </kbd> |
...
## Matrix Array (All matrices are column matrices)
### STD140
| Name             | Bytes                                                                                                                      |
|------------------|----------------------------------------------------------------------------------------------------------------------------|
| mat2x2\<int8>[]  | <kbd>[bb--][----][----][----]<br/>[bb--][----][----][----]                                                          </kbd> |
